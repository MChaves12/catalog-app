    ...
    <footer id="contact-us" className="max-container">
      <div className="flex justify-between items-start gap-20 flex-wrap max-lg:flex-col">
        <div className="flex flex-col items-star">
          ...
          <p className='mt-6 text-base leading-7 font-montserrat text-white-400 sm:max-w-sm'>Get ready for the new term 
          at your nearest store. Find Your perfect size in Store. 
          </p>
